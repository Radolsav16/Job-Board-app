...
export default function SignUp() {
  return (
    <form>
      <div className="space-y-12 mt-20 p-25">
      <div className="flex justify-center space-x-4 mt-5">
        <label className={`cursor-pointer px-4 py-2 rounded-full border ${false ? "bg-blue-500 text-white" : "bg-gray-100 text-gray-700"}`}>
          <input
            type="radio"
            value="jobseeker"
        ...
        <label className={`cursor-pointer px-4 py-2 rounded-full border ${true ? "bg-blue-500 text-white" : "bg-gray-100 text-gray-700"}`}>
          <input
            type="radio"
            value="employer"
        ...
        <div className="border-b border-gray-900/10 pb-12">
          ...
          <div className="sm:col-span-4">
            ...
            <div className="col-span-full">
              ...
              <p className="mt-3 text-sm/6 text-gray-600">Write a few sentences about company.</p>
            </div>
      ...
      <div className="mt-6 flex items-center justify-end gap-x-6 mr-30">
